define([
	...
	app.controller('statisticCtrl', ['$scope', '$http', '$state', function ($scope, $http, $state) {
		//---------------地图demo---------------------------------------------
		//数据
		var data = [
			{name: '海门', value: 9},
		...
		$.get('static/libs/echarts3.0/china.json', function (chinaJson) {
			//ajax获取地图
			...
			series : [
				{
					...
					data:[2000, 1700, 2400, 2440, 2000, 2200, 2100]
				},
				{
					name:'毕业总人数',
					type:'bar',
					...
					data:[3200, 3020, 3410, 3740, 3900, 4500, 4200]
				},
				{
					name:'未入库人数',
					type:'bar',
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		var option_pie = {
			...
			legend: {
				x : 'center',
				y : 'bottom',
				data:['农林牧渔','医药卫生','交通运输','机械机电','建筑建材','办公文教','石油化工','信息产业']
			},
			toolbox: {
				show : true,
				feature : {
